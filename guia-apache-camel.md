...
O instalador baixa do Maven Central, verifica checksums SHA-256 e valida que um runtime Java 25 está disponível. A instalação é por usuário e nunca requer `sudo`.
